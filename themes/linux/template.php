...
function linux_preprocess_page(&$vars,$hook) {
  ...
  //googlefont
  drupal_add_css('http://fonts.googleapis.com/css?family=Kreon:300,400,700|Open+Sans:300italic,400italic,600italic,700italic,800italic,400,600,700,800,300','external');
